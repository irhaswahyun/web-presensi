            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              {{-- <div class="d-flex justify-content-center py-4">
                <a href="" class="logo d-flex align-items-center w-auto">
                  <img src="{{ asset('backendo/assets/img/logo.png') }}" alt="">
                ...
                <div class="card-body">
                  ...
                  <form action="{{ route('register') }}" method="post" class="row g-3 needs-validation" novalidate>
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" name="name" :value="old('name')" class="form-control" id="name" required autocomplete="name">
                    ...
                    {{-- <div class="col-12">
                      ...
                      <input type="text" name="nip" :value="old('nip')" class="form-control" id="nip" required>
