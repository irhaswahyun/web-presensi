              ...
              <div class="box-body">
                  <div class="table-responsive">
                    <table id="example1" class="table table-bordered table-striped">
                      ...
                      <tbody>
                        @foreach($allDataJb as $key => $jb)
                          <tr>
                              <td>{{ $key + 1 }}</td>
                              <td>{{ $jb->nama_jabatan }}</td>
                              <td>
                                <a href="{{ route('jabatan.edit', $jb->id) }}" class="btn btn-info">Edit</a>
                                <a href="{{ route('jabatan.delete', $jb->id) }}" id= "delete" class="btn btn-danger">Delete</a>
                              </td>
                          </tr>
                          @endforeach
                      </tbody>
